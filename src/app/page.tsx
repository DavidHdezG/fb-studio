    ...
    <div className="bg-background min-h-screen w-full">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              <h3 className="text-3xl font-bold font-headline text-primary">Nuestra Visión</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center mt-20">
            ...
            <div className="space-y-4 order-1 md:order-2">
              <h3 className="text-3xl font-bold font-headline text-primary">Nuestra Misión</h3>
      ...
      <footer className="py-8 bg-card border-t">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Bifrost Code. Todos los derechos reservados.</p>
        </div>
      </footer>
    </div>
  );
